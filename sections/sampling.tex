...
\begin{frame}{Sensor sampling with ROS 2}{Driver modules}
  \justifying
	Sampling is generally handled by \textbg{microcontrollers}, but when the sampling frequency is \emph{not too high}, \emph{e.g.}, periods down to some $\mathrm{ms}$, it may be carried out by a higher-level device.\\
